              ...
              <div className='mb-10 ml-16'>
                  <div className='max-md:h-full max-sm:text-md max-sm:mx-auto max-sm:mt-5'>
                      <div className='mt-[200px]  max-md:mt-2 max-sm:mt-10'>
                          ...
                          <button className='btn bg-[#5F29B7] mt-4 w-[200px] font-[FontSpring] place-items-center  text-white text-[20px] hover:bg-[#884fe4]'>Sign Up
                              <span>
                          ...
                          <div className="mt-10">
                              <p className="font-[FontSpring]  text-[#FFFFFF] text-[22px] max-sm:text-md">
